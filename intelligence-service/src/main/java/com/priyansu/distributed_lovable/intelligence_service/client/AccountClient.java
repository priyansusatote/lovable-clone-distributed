package com.priyansu.distributed_lovable.intelligence_service.client;
...
@FeignClient(name = "account-service", path = "/account", url="${ACCOUNT_SERVICE_URI:}")  //also enable Feign client in main class
